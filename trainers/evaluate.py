...
from datasets.ImageDataset import ImageDataset, AdoptionImageDataset, CelebaImageDataset, SunImageDataset
from datasets.TabularDataset import TabularDataset, AdoptionTabularDataset, CelebaTabularDataset, SunTabularDataset
from datasets.ImagingAndTabularDataset import ImagingAndTabularDataset, AdoptionImagingAndTabularDataset, CelebaImagingAndTabularDataset, SunImagingAndTabularDataset
...
def load_datasets(hparams):
  if hparams.datatype == 'imaging' or hparams.datatype == 'multimodal':
    if hparams.target == 'adoption':
      train_dataset = AdoptionImageDataset(hparams.data_train_imaging, hparams.data_train_tabular,
      ...
      val_dataset = AdoptionImageDataset(hparams.data_val_imaging, hparams.data_val_tabular,
                                 hparams.delete_segmentation, hparams.eval_train_augment_rate,
                                 grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target, train=False,
                                 live_loading=hparams.live_loading, task=hparams.task)
    elif hparams.target == 'celeba':
      train_dataset = CelebaImageDataset(hparams.data_train_imaging, hparams.data_train_tabular,
                                   hparams.delete_segmentation, hparams.eval_train_augment_rate,
                                   grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target, train=True,
                                   live_loading=hparams.live_loading, task=hparams.task)
      val_dataset =  CelebaImageDataset(hparams.data_val_imaging, hparams.data_val_tabular,
                                 hparams.delete_segmentation, hparams.eval_train_augment_rate,
                                 grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target, train=False,
                                 live_loading=hparams.live_loading, task=hparams.task)
    elif hparams.target == 'sun':
      train_dataset = SunImageDataset(hparams.data_train_imaging, hparams.data_train_tabular,
                                         hparams.delete_segmentation, hparams.eval_train_augment_rate,
                                         grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target,
                                         train=True,
                                         live_loading=hparams.live_loading, task=hparams.task)
      val_dataset = SunImageDataset(hparams.data_val_imaging, hparams.data_val_tabular,
                                       hparams.delete_segmentation, hparams.eval_train_augment_rate,
                                       grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target,
                                       train=False,
                                       live_loading=hparams.live_loading, task=hparams.task)
    ...
    if hparams.target == 'adoption':
      train_dataset = AdoptionTabularDataset(hparams.data_train_tabular, hparams.eval_one_hot)
      val_dataset = AdoptionTabularDataset(hparams.data_val_tabular, hparams.eval_one_hot)
      hparams.input_size = train_dataset.get_input_size()
    elif hparams.target == 'celeba':
      train_dataset = CelebaTabularDataset(hparams.data_train_tabular, hparams.eval_one_hot)
      val_dataset = CelebaTabularDataset(hparams.data_val_tabular, hparams.eval_one_hot)
      hparams.input_size = train_dataset.get_input_size()
    elif hparams.target == 'sun':
      train_dataset = SunTabularDataset(hparams.data_train_tabular, hparams.eval_one_hot)
      val_dataset = SunTabularDataset(hparams.data_val_tabular, hparams.eval_one_hot)
      hparams.input_size = train_dataset.get_input_size()
    else:
    ...
    if hparams.target == 'adoption':
      train_dataset = AdoptionImagingAndTabularDataset(
        hparams.data_train_imaging, hparams.delete_segmentation, hparams.augmentation_rate,
        hparams.data_train_tabular, hparams.eval_one_hot,
        hparams.img_size, hparams.live_loading, train=True, target=hparams.target)
      val_dataset = AdoptionImagingAndTabularDataset(
        hparams.data_val_imaging, hparams.delete_segmentation, hparams.augmentation_rate,
        hparams.data_val_tabular, hparams.eval_one_hot,
        hparams.img_size, hparams.live_loading, train=True, target=hparams.target)
      hparams.input_size = train_dataset.get_input_size()
    elif hparams.target == 'celeba':
      train_dataset = CelebaImagingAndTabularDataset(
        hparams.data_train_imaging, hparams.delete_segmentation, hparams.augmentation_rate,
        hparams.data_train_tabular, hparams.eval_one_hot,
        hparams.img_size, hparams.live_loading, train=True, target=hparams.target)
      val_dataset = CelebaImagingAndTabularDataset(
        hparams.data_val_imaging, hparams.delete_segmentation, hparams.augmentation_rate,
        hparams.data_val_tabular, hparams.eval_one_hot,
        hparams.img_size, hparams.live_loading, train=True, target=hparams.target)
      hparams.input_size = train_dataset.get_input_size()
    elif hparams.target == 'sun':
      train_dataset = SunImagingAndTabularDataset(
        hparams.data_train_imaging, hparams.delete_segmentation, hparams.augmentation_rate,
        hparams.data_train_tabular, hparams.eval_one_hot,
        hparams.img_size, hparams.live_loading, train=True, target=hparams.target)
      val_dataset = SunImagingAndTabularDataset(
        hparams.data_val_imaging, hparams.delete_segmentation, hparams.augmentation_rate,
        hparams.data_val_tabular, hparams.eval_one_hot,
        hparams.img_size, hparams.live_loading, train=True, target=hparams.target)
      hparams.input_size = train_dataset.get_input_size()
...
def evaluate(hparams, wandb_logger):
  ...
  hparams["len_loader"] = len(train_loader)
  ...
  if hparams.test_and_eval:
    if hparams.datatype == 'imaging' or hparams.datatype == 'multimodal':
      if hparams.target == 'adoption':
        test_dataset = AdoptionImageDataset(
          hparams.data_test_eval_imaging, hparams.data_test_eval_tabular, hparams.delete_segmentation, 0, grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target, train=False, live_loading=hparams.live_loading, task=hparams.task)
        hparams.transform_test = test_dataset.transform_val.__repr__()
      elif hparams.target == 'celeba':
        test_dataset = CelebaImageDataset(
          hparams.data_test_eval_imaging, hparams.data_test_eval_tabular, hparams.delete_segmentation, 0, grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target, train=False, live_loading=hparams.live_loading, task=hparams.task)
        hparams.transform_test = test_dataset.transform_val.__repr__()
      elif hparams.target == 'sun':
        test_dataset = SunImageDataset(
          hparams.data_test_eval_imaging, hparams.data_test_eval_tabular, hparams.delete_segmentation, 0,
          grab_arg_from_checkpoint(hparams, 'img_size'), target=hparams.target, train=False,
          live_loading=hparams.live_loading, task=hparams.task)
        hparams.transform_test = test_dataset.transform_val.__repr__()
      else:
      ...
      if hparams.target == 'adoption':
        test_dataset = AdoptionTabularDataset(hparams.data_test_eval_tabular, hparams.eval_one_hot)
        hparams.input_size = test_dataset.get_input_size()
      elif hparams.target == 'celeba':
        test_dataset = CelebaTabularDataset(hparams.data_test_eval_tabular, hparams.eval_one_hot)
        hparams.input_size = test_dataset.get_input_size()
      elif hparams.target == 'sun':
        test_dataset = SunTabularDataset(hparams.data_test_eval_tabular, hparams.eval_one_hot)
        hparams.input_size = test_dataset.get_input_size()
      else:
      ...
      if hparams.target == 'adoption':
        test_dataset = AdoptionImagingAndTabularDataset(
          hparams.data_test_eval_imaging, hparams.delete_segmentation, 0,
          hparams.data_test_eval_tabular, hparams.eval_one_hot,
          hparams.img_size, hparams.live_loading, train=False, target=hparams.target)
        hparams.input_size = test_dataset.get_input_size()
      elif hparams.target == 'celeba':
        test_dataset = CelebaImagingAndTabularDataset(
          hparams.data_test_eval_imaging, hparams.delete_segmentation, 0,
          hparams.data_test_eval_tabular, hparams.eval_one_hot,
          hparams.img_size, hparams.live_loading, train=False, target=hparams.target)
        hparams.input_size = test_dataset.get_input_size()
      elif hparams.target == 'sun':
        test_dataset = SunImagingAndTabularDataset(
          hparams.data_test_eval_imaging, hparams.delete_segmentation, 0,
          hparams.data_test_eval_tabular, hparams.eval_one_hot,
          hparams.img_size, hparams.live_loading, train=False, target=hparams.target)
        hparams.input_size = test_dataset.get_input_size()
